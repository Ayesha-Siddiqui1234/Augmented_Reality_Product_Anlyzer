...
const ProductDetailPage = () => {
  ...
  const relatedProducts = useSelector((state) =>
    product ? selectRelatedProducts(state, productId, product.category) : []
  )
  ...
  const isFavorited = useSelector((state) =>
    product && userId
      ? selectIsFavoriteByUser(state, userId, productId)
      : false
  )
  ...
  const images = product.gallery || product.images || [product.imageUrl]
        ...
        <div className="max-w-7xl mx-auto px-6 py-28">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-20">
            ...
            <div className="space-y-6">
              {/* Category */}
              <p className="text-purple-400/60 text-xs tracking-[0.3em] uppercase">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-purple-400/60 text-sm">
                  ({product.reviewCount || product.numReviews || 0} reviews)
                </span>
              </div>
              ...
              {/* Short Description */}
              <p className="text-purple-100/60 text-base leading-relaxed">
              ...
              <div>
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="w-16 text-center text-lg font-bold text-purple-400">
                    {quantity}
                  </span>
                  ...
                  <button
                    onClick={() => {
                      if (quantity >= product.stock) {
                        alert(
                          `Maximum stock limit reached! Only ${product.stock} items available.`
                        )
                      } else {
                  ...
                  <div className="space-y-4">
                    <div className="p-6 rounded-xl border border-purple-400/15 bg-[#09070f]/40">
                      ...
                      <p className="text-purple-100/60 text-sm leading-relaxed">
                        Excellent quality! The AR preview helped me visualize it
                        perfectly in my room. Highly recommended!
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                {relatedProducts.slice(0, 4).map((relatedProduct) => {
                  const relatedProductId = relatedProduct._id || relatedProduct.id
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="p-4">
                        ...
                        <h3 className="text-purple-100 font-semibold text-sm leading-snug mb-2">
                          {relatedProduct.name}
                        </h3>
